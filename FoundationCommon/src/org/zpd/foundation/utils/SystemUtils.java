...
/**
 * Created by apple10 on 15/12/1.
 */
public class SystemUtils {

    static public String MacOS = "Mac OS";

    static public String Windows = "Windows";

    static public String Linux = "Linux";

    static public String OtherOS = "OtherOS";

    static public String currentSystem(){
        String osName = System.getProperties().getProperty("os.name");
        if (osName.startsWith(SystemUtils.MacOS)){
            return MacOS;
        }else if (osName.startsWith(SystemUtils.Windows)){
            return Windows;
        }else if (osName.startsWith(SystemUtils.Linux)){
            return Linux;
        }else {
            return SystemUtils.OtherOS;
        }
    }
