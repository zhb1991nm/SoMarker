...
//            chromosomeComboBox.getCheckModel().clearChecks();
            ...
            HBox line2 = new HBox(ppFromLabel,ppFromTextField,ppToLabel,ppToTextField,rfLabel,rfTextField);
...
//                chromosomeComboBox.getCheckModel().clearChecks();
            ...
            TableColumn<FluorescentMarkerEntity,String> col4 = new TableColumn<>("image");
            col4.setSortable(false);
            col4.setCellFactory(param -> new ImageTableCell(new ImageTabelCellHandler() {
                @Override
            ...
            col4.setCellValueFactory(new PropertyValueFactory<FluorescentMarkerEntity,String>("image"));
            tableView.getColumns().addAll(col0,col1,col2,col3,col4);
